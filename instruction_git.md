...
1. Необходимо зайти в чужой репозиторий через ***github*** и выделить необходимый репозиторий для копирования. 
...
3. Для копирования из вашего удаленного в локальный репозиторий, в VSC создается новая папка.    
